...
WINDOWSloghook.send(emergencyebed)
	console.error('Cutting Connection... Done.')
	console.error('Stopping Listener From Listening... Done.')
	console.error('Unloading Files... Done.')
	console.error('Logging Out... Done.')
	console.error('Stopping Client... Done.')
